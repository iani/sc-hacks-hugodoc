...
** History
:PROPERTIES:
:filename-not: history
:END:

/sc-hacks/ was motivated by the need to improve some aspects [[http://doc.sccode.org/Overviews/JITLib.html][JITLib]], such as:
- The handling of audio busses for linking i/o between synths.
